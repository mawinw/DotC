...
public class Map {
	...
	public static Parent createContent() {
		...
		board[2][4].setTileType(TileType.MONSTER); slime1.setPosition(2, 4); slime1.draw();
		board[4][4].setTileType(TileType.MONSTER); slime2.setPosition(4, 4); slime2.draw();
		board[7][1].setTileType(TileType.MONSTER); slime3.setPosition(7, 1); slime3.draw();
		board[7][7].setTileType(TileType.MONSTER); slime4.setPosition(7, 7); slime4.draw();
	...
	public static void setBoard(int x,int y,TileType tileType) {
		Tile tile = new Tile((x+y)%2==0,x,y);
